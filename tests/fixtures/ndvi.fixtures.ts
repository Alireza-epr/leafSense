...
export const makeSamples = (values: number[]): INDVISample[] =>
  values.map((v, i) =>
    createNDVISample({
      id: i + 1,
      meanNDVI: v,
      datetime: `2025-01-${i + 1}T00:00:00Z`,
    }),
  );
...
const stacItems = [
  { datetime: "2025-01-01", ndviArray: makeNDVIPixels(0.1) },
  ...
  { datetime: "2025-01-07", ndviArray: makeNDVIPixels(0.5) }, // big jump
  ...
  { datetime: "2025-01-13", ndviArray: makeNDVIPixels(0.6) }, // smaller jump
